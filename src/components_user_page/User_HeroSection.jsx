            ...
            <div className='flex flex-row flex-wrap -mx-3 mt-41.75'>
                <div className='flex flex-row max-lg:flex-col gap-15.5 px-3 '>
                    <div className='max-lg:items-center max-lg:justify-center max-lg:flex'>
                        <img src="./assets/images/partyfour.png" alt="image" className='w-100.25 h-102 max-lg:px-2' />
                    </div>
                    <div className='flex flex-col max-lg:px-2'>
                        <span className="text-black/60 [font-poppins] font-normal text-[16px] leading-[150%] tracking-[0] max-[800px]:text-center">
                            {`Home  >  Username`}
                        </span>
                        <div className='flex flex-row  min-[1200px]:items-center justify-between max-[1200px]:flex-col max-[800px]:flex-col max-[1024px]:flex-row  pt-3 pb-4 '>
                            <h3 className=' text-black font-[poppins] font-semibold text-[48px] leading-[150%] tracking-[0]  max-[800px]:text-center'>
                                Jhone Doe
                            </h3>
                            <div className='flex flex-row items-center justify-center gap-3.25 font-[Poppins] text-[16px] font-semibold leading-[150%] tracking-[0%]  max-[540px]:flex-col max-[540px]:w-full'>
                                <div className='text-black bg-[rgba(44,73,254,0.1)] py-2.75 px-7 rounded-[23px]'>Unshow Journey of Feed</div>
                                <div className='text-white bg-[#2C49FE] py-2.75 px-7 rounded-[23px]'>Show Journey of Feed</div>
                            </div>
                        </div>
                        <p className='max-[800px]:text-center max-lg:max-w-full max-w-215.5 text-black/60 font-[Poppins] font-normal text-[16px] leading-[150%] tracking-[0] pb-9.5'>
                            Dictumst vulputate eget quisque iaculis hendrerit quis ut fringilla.
                            Senectus gravida sed interdum pretium at quam morbi.
                            Nunc, libero nam cursus sem faucibus urna. Hendrerit vulputate in duis donec sit.
                            Ut vitae dolor fringilla urna eget aliquet.
                        </p>
                        <div className="flex flex-row gap-8.75 items-center max-[605px]:flex-col max-[800px]:justify-center">
                            <div className='flex-row flex gap-8.75'>
                                <span className="flex items-center gap-2 opacity-60">
                                    ...
                                    <span className='font-[Poppins] text-[16px] font-normal leading-[150%] tracking-[0%]'>10/02/2022</span>
                                </span>
                                <span className="flex items-center gap-2 opacity-60">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_102077_179)">
                                            <path
                                        ...
                                        <defs>
                                            <clipPath id="clip0_102077_179">
                                                <rect width="24" height="24" fill="white" />
                                            </clipPath>
                                        </defs>
                                    </svg>
                                    <span className='font-[Poppins] text-[16px] font-normal leading-[150%] tracking-[0%]'>Mumbai</span>
                                </span>
                            </div>
                                ...
                                <span className="flex items-center gap-2 opacity-60">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#666666" />
                                        <path
                                            d="M20.25 14.5426H18C17.8011 14.5426 17.6103 14.4635 17.4697 14.3229C17.329 14.1822 17.25 13.9915 17.25 13.7926C17.25 13.5936 17.329 13.4029 17.4697 13.2622C17.6103 13.1216 17.8011 13.0426 18 13.0426H20.25C20.6478 13.0426 21.0294 12.8845 21.3107 12.6032C21.592 12.3219 21.75 11.9404 21.75 11.5426V10.7401L19.8375 9.99005C19.7458 9.95368 19.6623 9.8996 19.5915 9.83089C19.5208 9.76219 19.4643 9.68021 19.4253 9.58965C19.3863 9.49909 19.3655 9.40172 19.3642 9.30313C19.3629 9.20453 19.381 9.10664 19.4175 9.01505C19.4896 8.83042 19.6318 8.68181 19.8131 8.60171C19.9943 8.5216 20.2 8.51651 20.385 8.58755L22.7775 9.52505C22.917 9.58063 23.0367 9.67683 23.1209 9.80119C23.2052 9.92555 23.2501 10.0723 23.25 10.2226V11.5351C23.251 11.9296 23.1741 12.3206 23.0238 12.6854C22.8735 13.0502 22.6526 13.3819 22.374 13.6612C22.0953 13.9406 21.7643 14.1622 21.3998 14.3135C21.0353 14.4647 20.6446 14.5426 20.25 14.5426Z"
                                            fill="#666666" />
                                    </svg>
                                    <span className='font-[Poppins] text-[16px] font-normal leading-[150%] tracking-[0%]'>1,080</span>
                                </span>
                                <span className="flex items-center gap-2 opacity-60">
                                    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20.7114 3.71409C20.6184 3.80782 20.5078 3.88221 20.3859 3.93298C20.2641 3.98375 20.1334 4.00989 20.0014 4.00989C19.8693 4.00989 19.7386 3.98375 19.6168 3.93298C19.4949 3.88221 19.3843 3.80782 19.2914 3.71409L19.0014 3.41409L12.9014 9.52409L10.0014 20.2641C9.94276 20.4823 9.81202 20.6741 9.63044 20.8085C9.44885 20.9429 9.22712 21.0118 9.00136 21.0041C8.79172 21.0046 8.5872 20.9393 8.41673 20.8172C8.24626 20.6952 8.11845 20.5227 8.05136 20.3241L6.21136 14.7941L0.68136 13.0041C0.474379 12.9345 0.295862 12.7991 0.173074 12.6185C0.0502863 12.438 -0.0100221 12.2222 0.00135996 12.0041C-0.00637328 11.7783 0.0625597 11.5566 0.196932 11.375C0.331304 11.1934 0.523198 11.0627 0.74136 11.0041L11.4814 8.10409L17.5914 2.00409L17.2914 1.71409C17.1031 1.52579 16.9973 1.27039 16.9973 1.00409C16.9973 0.73779 17.1031 0.482395 17.2914 0.294092C17.4797 0.105788 17.7351 0 18.0014 0C18.2677 0 18.5231 0.105788 18.7114 0.294092L20.7114 2.29409C20.8051 2.38705 20.8795 2.49766 20.9303 2.61951C20.981 2.74137 21.0072 2.87208 21.0072 3.00409C21.0072 3.1361 20.981 3.26681 20.9303 3.38867C20.8795 3.51053 20.8051 3.62113 20.7114 3.71409Z" fill="#666666" />
                                    </svg>
                                    <span className='font-[Poppins] text-[16px] font-normal leading-[150%] tracking-[0%]'>1,080</span>
                                </span>
                                <span className="flex items-center gap-2 opacity-60">
                                    <svg width="20" height="11" viewBox="0 0 20 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.8125 0H1.6875C0.75 0 0 0.75 0 1.6875V8.55C0 9.4875 0.75 10.2375 1.6875 10.2375H17.8125C18.75 10.2375 19.5 9.4875 19.5 8.55V6.825C19.5 6.6375 19.35 6.45 19.1625 6.45C18.45 6.375 17.9625 5.8125 17.9625 5.1375C17.9625 4.4625 18.4875 3.9 19.1625 3.825C19.35 3.825 19.5 3.6375 19.5 3.45V1.725C19.5 0.75 18.75 0 17.8125 0ZM18.75 3.1125C17.85 3.3375 17.175 4.1625 17.175 5.1C17.175 6.0375 17.8125 6.8625 18.75 7.0875V8.5125C18.75 9.0375 18.3375 9.45 17.8125 9.45H14.7V8.5125C14.7 8.2875 14.55 8.1375 14.325 8.1375C14.1 8.1375 13.95 8.2875 13.95 8.5125V9.45H1.6875C1.1625 9.45 0.75 9.0375 0.75 8.5125V1.6875C0.75 1.1625 1.1625 0.75 1.6875 0.75H13.95V1.6875C13.95 1.9125 14.1 2.0625 14.325 2.0625C14.55 2.0625 14.7 1.9125 14.7 1.6875V0.75H17.8125C18.3375 0.75 18.75 1.1625 18.75 1.6875V3.1125Z" fill="#666666" />
                                        <path d="M14.3242 3.59998C14.0992 3.59998 13.9492 3.74998 13.9492 3.97498V6.22498C13.9492 6.44998 14.0992 6.59998 14.3242 6.59998C14.5492 6.59998 14.6992 6.44998 14.6992 6.22498V3.97498C14.6992 3.74998 14.5117 3.59998 14.3242 3.59998Z" fill="#666666" />
                                    </svg>
                                    <span className='font-[Poppins] text-[16px] font-normal leading-[150%] tracking-[0%]'>1,080</span>
                                </span>
                            </div>
...
export default User_HeroSection